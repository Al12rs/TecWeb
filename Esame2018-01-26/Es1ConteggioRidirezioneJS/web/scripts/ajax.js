...
var responseHandler = function (responseText, targetElement) {
	if(responseText != null || responseText != ""){
		...
		targetElement.innerHTML="<h3>"+result+"</h3>";
	}else{
		targetElement.innerHTML="<h3>Errore: sarai ridirezionato a home.html in 5 secondi.</h3>";
		setTimeout(function(){
			var currentURL = window.location.href;
			var homeURL = currentURL.slice(0, currentURL.search("?"));
