...
var responseHandler = function(responseText, targetElement) {
	if(responseText != null){
		...
		var loadedMessages = document.getElementById("messages").querySelectorAll(".brMessage");
		var newMessages = result - loadedMessages.length;
		targetElement.innerHTML = newMessages + " nuovi messaggi disponibili! Fai il refresh!";
	} else {
		targetElement.innerHTML = "Non sono stato in grado di controllare se ci fossero nuovi messaggi.";
	}
}
...
function checkForNewMessages() {
	...
	var uri = "../chatagent?check=true";
	var targetElement = myGetElementById("newMessages");
