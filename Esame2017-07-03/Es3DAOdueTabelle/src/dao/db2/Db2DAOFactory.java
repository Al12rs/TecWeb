...
public class Db2DAOFactory extends DAOFactory {
	...
	public SquadraPallacanestroDAO getSquadraPallacanestroDAO() {
		return new Db2SquadraPallacanestroDAO();
	}

	@Override
	public GiocatoreSquadraPallacanestroMappingDAO getGiocatoreSquadraPallacanestroMappingDAO() {
		return new Db2GiocatoreSquadraPallacanestroMappingDAO();
	}
