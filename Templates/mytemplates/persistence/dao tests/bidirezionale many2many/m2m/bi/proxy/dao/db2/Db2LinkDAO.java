...
public class Db2LinkDAO implements LinkDAO {
	...
	// create table
	private static String create = "CREATE TABLE link (id_Passeggero BIGINT NOT NULL REFERENCES passeggero(id),id_Volo BIGINT NOT NULL REFERENCES volo(id), PRIMARY KEY(id_Passeggero, id_Volo))";
