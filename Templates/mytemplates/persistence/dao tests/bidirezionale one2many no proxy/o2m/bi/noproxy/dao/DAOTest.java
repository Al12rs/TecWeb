...
import o2m.bi.noproxy.utils.SqlUtils;

public class DAOTest {
	public static final int DAO = DAOFactory.DB2;
	private static DAOFactory daoFactoryInstance;
	private static CittaDAO cittaDao;
	private static MaratonaDAO maratonaDao;

	public static void main(String[] args) {
		daoFactoryInstance = DAOFactory.getDAOFactory(DAO);
		cittaDao = daoFactoryInstance.getCittaDAO();
		maratonaDao = daoFactoryInstance.getMaratonaDAO();
	...
	private static void enterEntries() {
		...
		MaratonaDTO m1 = new MaratonaDTO(1, 1, "m1", SqlUtils.randomSqlDate(), "maratona intera", c1);
		MaratonaDTO m2 = new MaratonaDTO(2, 2, "m2", SqlUtils.randomSqlDate(), "maratona mezza", c1);
		MaratonaDTO m3 = new MaratonaDTO(3, 3, "m3", SqlUtils.randomSqlDate(), "maratona mezza", c2);
		MaratonaDTO m4 = new MaratonaDTO(4, 4, "m4", SqlUtils.randomSqlDate(), "maratona mezza", c2);
		MaratonaDTO m5 = new MaratonaDTO(5, 5, "m5", SqlUtils.randomSqlDate(), "maratona intera", c1);
		MaratonaDTO m6 = new MaratonaDTO(6, 6, "m6", SqlUtils.randomSqlDate(), "maratona mezza", c1);
		MaratonaDTO m7 = new MaratonaDTO(7, 7, "m7", SqlUtils.randomSqlDate(), "maratona mezza", c2);
		MaratonaDTO m8 = new MaratonaDTO(8, 8, "m8", SqlUtils.randomSqlDate(), "maratona mezza", c2);
