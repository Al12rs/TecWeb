...
public class DAOgenerator
{
	...
	public static void main(String[] args) throws IOException
	{
		...
		objName="Partner"; //nome del bean (iniziale maiuscola!!)
		tableName="partner"; //nome della tabella

		//non inserire "long id"!! (generato automaticamente)
		attr.add("String siglaPartner"); //coppie "tipo nome" separate da uno spazio
