...
public class LoginServlet extends HttpServlet {
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        if (sessionTracker == null) {
            sessionTracker = new Hashtable<String, SessionInfo>();
            application.setAttribute("sessionTracker", sessionTracker);
        }
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        synchronized (application) {
            Hashtable<String, SessionInfo> sessionTracker = (Hashtable<String, SessionInfo>) application.getAttribute("sessionTracker");
            if (sessionTracker != null) {
                sessionTracker.put(req.getSession().getId(), new SessionInfo(req.getSession()));
            }
        }
